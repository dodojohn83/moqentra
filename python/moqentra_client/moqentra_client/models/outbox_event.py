...
class OutboxEvent(BaseModel):
    ...
    aggregate_type: Optional[StrictStr] = None
    aggregate_id: Optional[StrictStr] = None
    event_type: Optional[StrictStr] = None
    payload: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["id", "aggregate_type", "aggregate_id", "event_type", "payload"]
