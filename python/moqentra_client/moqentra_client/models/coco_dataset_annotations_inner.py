...
class CocoDatasetAnnotationsInner(BaseModel):
    """
    ...
    iscrowd: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["id", "image_id", "category_id", "bbox", "segmentation", "keypoints", "area", "iscrowd"]
