...
from moqentra_client.configuration import Configuration
from moqentra_client.api_response import ApiResponse, T as ApiResponseT
import moqentra_client.models
from moqentra_client import rest
from moqentra_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(moqentra_client.models, klass)
