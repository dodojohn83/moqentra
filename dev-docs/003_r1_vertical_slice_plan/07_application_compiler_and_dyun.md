...
- [ ] `R1-APP-001` 持久化 Application、不可变 ApplicationVersion、ComponentCatalog、Binding、Deployment 和状态历史。
- [ ] `R1-APP-002` 建立版本化组件目录，首批包含 RTSP source、decode、preprocess、inference、postprocess、tracker、OSD、encode 和 RTMP sink；端口、参数、能力和资源 schema 明确。
